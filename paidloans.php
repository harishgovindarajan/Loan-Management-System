...
<table>
    ...
    <tbody>
        ...
        if (isset($_SESSION['borrower_email'])) {
            ...
            $sql = "SELECT id, name, email, phone, loan_start_date, loan_amount, period, interest_rate, payable_amount, payment_date, loan_status FROM borrowers WHERE email = '$email' AND loan_status = 'Paid'";
            ...
            echo "Session variable 'borrower_email' is not set.";
        }
